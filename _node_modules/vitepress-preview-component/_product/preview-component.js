import { openBlock as a, createElementBlock as C, createElementVNode as i, ref as v, defineComponent as b, watch as Z, createBlock as y, Transition as O, withCtx as R, normalizeClass as u, unref as n, normalizeStyle as P, createVNode as M, toDisplayString as $, createCommentVNode as H, createApp as j, computed as A, onMounted as T, renderSlot as N, resolveComponent as q } from "vue";
const x = (o, e) => {
...
const I = /* @__PURE__ */ x(G, [["render", K]]), Q = {}, W = {
  t: "1661231449868",
  class: "icon",
  viewBox: "0 0 1024 1024",
  version: "1.1",
...
const D = /* @__PURE__ */ x(Q, [["render", X]]), Y = {}, ee = {
  viewBox: "0 0 544 560",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
};
function te(o, e) {
  return a(), C("svg", ee, e[0] || (e[0] = [
    i("path", {
...
const S = /* @__PURE__ */ x(Y, [["render", te]]), w = "vitepress-demo-preview", k = (o, e, t, c) => {
  let l = e === "" ? `${o}` : `${o}-${e}`;
...
const ce = /* @__PURE__ */ x(ne, [["render", se]]), ie = /* @__PURE__ */ b({
...
const B = [], z = {
  open: () => {
    const o = document.createElement("div"), e = j(ie, {
      content: "\u590D\u5236\u6210\u529F\uFF01",
      close: () => {
        document.body.removeChild(o), B.pop(), e.unmount();
      }
    }), t = e.mount(o);
    document.body.appendChild(o);
    const c = B.length, l = c === 0 ? 10 : (c + 1) * 10 + c * 42;
    t.setTopHeight(l), t.setVisible(!0), B.push(t);
  }
}, le = ["innerHTML"], re = ["innerHTML"], pe = /* @__PURE__ */ b({
  __name: "AntDesign",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const e = o, t = F(), { isCodeFold: c, setCodeFold: l } = U(), { copyContent: _, clickCopy: m } = E(), L = v(decodeURIComponent(e.code)), p = v(decodeURIComponent(e.showCode)), d = v(null), g = () => {
      m(L.value), z.open();
    }, h = A(() => {
      var r;
    ...
    return T(() => {
      ...
      i("section", {
        ...
        i("div", {
          ...
          n(c) ? (a(), y(I, {
            key: 1,
            onClick: f[1] || (f[1] = (V) => n(l)(!1))
          })) : (a(), y(D, {
            key: 0,
            onClick: f[0] || (f[0] = (V) => n(l)(!0))
          })),
          M(S, { onClick: g })
        ], 2)
      ], 2),
...
const ue = ["innerHTML"], Ce = /* @__PURE__ */ b({
  __name: "ElementPlus",
  props: {
    code: {},
    showCode: {},
  ...
  setup(o) {
    const e = o, t = F(), { isCodeFold: c, setCodeFold: l } = U(), { clickCopy: _ } = E(), m = v(decodeURIComponent(e.code)), L = v(decodeURIComponent(e.showCode)), p = v(null), d = () => {
      _(m.value), z.open();
    }, g = A(() => {
      var s;
      ...
      return a(), C("div", {
        ...
        i("section", {
          ...
          i("div", {
            ...
            n(c) ? (a(), y(I, {
              key: 1,
              onClick: r[1] || (r[1] = (V) => n(l)(!1))
            })) : (a(), y(D, {
              key: 0,
              onClick: r[0] || (r[0] = (V) => n(l)(!0))
            })),
            M(S, { onClick: d })
          ], 2)
        ], 2),
...
const ae = ["innerHTML"], ve = /* @__PURE__ */ b({
  __name: "NaiveUI",
  props: {
    code: {},
    showCode: {},
