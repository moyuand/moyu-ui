<template>
  ...
  <p>
    ...
    <my-button type="primary" icon="edit" circle />
    <my-button type="success" icon="check" circle />
    <my-button type="info" icon="message" circle />
    <my-button type="warning" icon="star" circle />
    <my-button type="danger" icon="trash" circle />
  </p>
</template>