...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".my-collapse-item__header");
    contents = wrapper.findAll(".my-collapse-item__wapper");
  ...
  test("手风琴模式 错误处理", () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
      `
        [
          [
            [MyUIError: [MyCollapse]:accordion mode should only have one active item],
          ],
        ]
      `
    );
